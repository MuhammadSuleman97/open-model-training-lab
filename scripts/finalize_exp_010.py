#!/usr/bin/env python3
"""Validate, package and round-trip Experiment 010 without test access."""
...
TRAINING_RESULT_PATH = PROJECT_ROOT / "artifacts" / "encoder" / "exp-010" / "training_result.json"
RESULT_PATH = PROJECT_ROOT / "artifacts" / "encoder" / "exp-010" / "result.json"
SELECTED_MODEL_DIR = PROJECT_ROOT / "artifacts" / "encoder" / "exp-010" / "selected-model"
...
def stop(message: str) -> None:
    raise SystemExit(f"Experiment 010 finalization stopped: {message}")
...
print("Open Model Training Lab — Experiment 010 validation-only finalization")
...
result = {
    ...
    "parent_validation_accuracy": training_result["parent_validation_accuracy"],
    "strict_validation_improvement": selected_metrics["accuracy"] - training_result["parent_validation_accuracy"],
...
print("exp_010_finalization_ok: True")
