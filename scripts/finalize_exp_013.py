#!/usr/bin/env python3
"""Select and round-trip Experiment 013 using validation data only."""
...
TRAINING_RESULT_PATH = PROJECT_ROOT / "artifacts" / "encoder" / "exp-013" / "training_result.json"
RESULT_PATH = PROJECT_ROOT / "artifacts" / "encoder" / "exp-013" / "result.json"
SELECTED_MODEL_DIR = PROJECT_ROOT / "artifacts" / "encoder" / "exp-013" / "selected-model"
...
def stop(message: str) -> None:
    raise SystemExit(f"Experiment 013 finalization stopped: {message}")
...
print("Open Model Training Lab — Experiment 013 validation-only finalization")
...
print("exp_013_finalization_ok: True")
