#!/usr/bin/env python3
"""Run the lower-learning-rate DeBERTa stability retry."""
...
os.environ["OPEN_MODEL_TRAINING_CONFIG"] = str(
    PROJECT_ROOT / "configs" / "exp-009b-deberta-v3-large-stability.json"
)
os.environ["OPEN_MODEL_TRAINING_RESULT_DIR"] = str(
    PROJECT_ROOT / "artifacts" / "encoder" / "exp-009b-probe"
)
